...
Mobile.verifyElementText(findTestObject('Object Repository/Detail Page/textViewNameTodo'), name)
Mobile.verifyElementText(findTestObject('Object Repository/Detail Page/textViewDateTodo'), expectedDate)
Mobile.verifyElementText(findTestObject('Object Repository/Detail Page/textViewTypeTodo'), type)
Mobile.verifyElementText(findTestObject('Object Repository/Detail Page/textViewDescriptionTodo'), description)
if(isChooseFile) {
	Mobile.verifyElementExist(findTestObject('Object Repository/Detail Page/imageViewTodo'), GlobalVariable.timeout)
}else {
	Mobile.verifyElementNotExist(findTestObject('Object Repository/Detail Page/imageViewTodo'), 2)
}
